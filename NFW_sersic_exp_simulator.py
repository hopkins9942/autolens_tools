...
save_path = (
    "/home/matthew/Durham2020/MyScripts/autolens_tools/ExampleData/NFW_sersic_exp/"
    + dataset_name
    + "/"
)
...
def intensity_setter(target_e_radius, target_mass_ratio):
    ...
    def func(intensities):
        ...
        temp_e_radius = al.Galaxy(
            0.5, sersic=sersic, exp=exp, dark=dark_profile
        ).einstein_radius_in_units()
        temp_mass_ratio = sersic.mass_within_circle_in_units(
            10
        ) / exp.mass_within_circle_in_units(10)
